      ...
      >
        ...
        <div className="shrink-0 space-y-2">
          ...
          <div className="flex items-center justify-center gap-3 pt-1 border-t border-zinc-800">
            <span className="text-zinc-600 text-[9px] font-mono">Made with care by Victor Galvez</span>
            <a href="https://github.com/victorgalvez56" target="_blank" rel="noopener noreferrer" className="text-zinc-600 hover:text-zinc-400 transition-colors">
            ...
            <a href="https://www.linkedin.com/in/victorgalvez56/" target="_blank" rel="noopener noreferrer" className="text-zinc-600 hover:text-zinc-400 transition-colors">
